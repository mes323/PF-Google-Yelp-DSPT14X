...
LOCAL_FOLDER = '/home/airflow/gcs/data/gmaps_metadata_bulk'  # Asegúrate que este sea el mount del folder local
GCS_TARGET_FOLDER = 'raw/gmaps_metadata/'
CLOUD_RUN_URL = 'https://transform-metadata-gmap-808937578837.us-central1.run.app'
BQ_OUTPUT_TABLE = 'datawave-proyecto-final.gmaps_dataset.metadata'
...
def enviar_telegram_mensaje():
    mensaje = "✅ DAG Finalizado: dag_metadata_gmaps_upload_process"
...
with DAG(
    dag_id='dag_metadata_gmaps_upload_process',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    tags=['gmaps', 'metadata', 'cloud_run', 'bigquery']
) as dag:
    ...
    process_task = PythonOperator(
        task_id='process_metadata_with_cloud_run',
